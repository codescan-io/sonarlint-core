...
public enum Language {
  ...
  APEX("sf", "sf", "APEX", new String[] {".cls", ".trigger"}, "sf.apex.suffixes"),
  ...
  SF_META("sfmeta", "sfmeta", "Salesforce Metadata (BETA)", new String[] {".settings", ".object"}, "sf.sfmeta.suffixes"),
  ...
  VF("vf", "vf", "Visual Force & Lightning", new String[] {".page", ".component", ".app", ".evt", ".cmp", ".intf"}, "sf.vf.suffixes"),
