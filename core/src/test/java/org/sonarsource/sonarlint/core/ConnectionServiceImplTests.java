...
class ConnectionServiceImplTests {
  ...
  public static final SonarCloudConnectionConfigurationDto SC_DTO_1 = new SonarCloudConnectionConfigurationDto("sc1", "https://app.codescan.io", "org1", true);
  public static final SonarCloudConnectionConfigurationDto SC_DTO_2 = new SonarCloudConnectionConfigurationDto("sc2", "https://app.codescan.io", "org2", true);
